...
# We need to load all tables from both Storage and AuthService
# Creating temporary instances to access their metadata
temp_storage = Storage(cfg=None) # We don't need a DB connection here
temp_auth_service = AuthService(storage=temp_storage)
target_metadata = temp_storage.meta
# --- END CUSTOM PART ---
